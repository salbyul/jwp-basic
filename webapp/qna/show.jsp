			...
			<div class="content-main">
				...
				<div class="qna-comment">
					<div class="qna-comment-slipp">
						<p class="qna-comment-count"><strong id="countsOfAnswer">${question.countOfComment}</strong>개의 의견</p>
						<div class="qna-comment-slipp-articles">
							...
							<article class="article">
								<div class="article-header">
									...
									<div class="article-header-text">
										${answer.writer}
										<div class="article-header-time">${fn:substring(answer.createdDate, 0, 16)}</div>
									</div>
								</div>
									...
									<ul class="article-util-list">
										...
										<li>
											<form class="form-delete" action="/api/qna/deleteAnswer" method="POST">
												...
												<button type="submit" class="link-delete-article" id="delete-answer">삭제</button>
											</form>
										</li>
									</ul>
								</div>
